...
const MissionModule = ({
  ...
  const renderCtaButton = () => {
    if (isCompletedMission) {
      return (
        <TouchableOpacity
          onPress={() => (onClaimReward ? onClaimReward() : onOpenOfferwall())}>
          <View
            style={[
            ...
            <View style={styles.offerwallBButtonTextWrapper}>
              <Image
                source={
                  bottomIconUrl
                    ? {uri: bottomIconUrl}
                    : require('../../assets/images/img_offerwall_coin.png')
                }
                style={[
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.rewardCoinBox}>
            <Image
              source={
                rewardIconUrl
                  ? {uri: rewardIconUrl}
                  : require('../../assets/images/img_reward_coin.png')
              }
      ...
      <View style={styles.stepBox}>
        {Array.from({length: maxStep}, (_, index) => renderStepItem(index))}
      </View>
      {isMissionListExist &&
        !isCompletedMission &&
        !networkError &&
              ...
              {missions.map((item, index) => (
                <TouchableOpacity
                  ...
                  <View
                    style={[
                      styles.missionItem,
                      item.isCompleted && styles.missionItemCompleted,
                    ]}>
                    <Image
                      source={{
                        uri:
                          item.imageUrl ||
                          'https://via.placeholder.com/52x52/FF9500/FFFFFF?text=M',
                        headers: {
                      ...
                      defaultSource={{
                        uri: 'https://via.placeholder.com/52x52/FF9500/FFFFFF?text=M',
                      }}
                    />
