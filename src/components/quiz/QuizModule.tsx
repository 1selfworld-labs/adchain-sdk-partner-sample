      ...
      if (completedQuizBanner.completedImageUrl === '') {
        return (
          <TouchableOpacity
            ...
            onPress={() => onOpenOfferwall && onOpenOfferwall()}>
            <Image
              source={require('../../assets/images/img_empty_quiz_2.png')}
              style={styles.emptyBannerImage}
            />
          </TouchableOpacity>
        );
          ...
          <TouchableOpacity
            ...
            <Image
              ...
              style={[
                ...
                {
                  aspectRatio:
                    completedQuizBanner.completedImageWidth /
                    completedQuizBanner.completedImageHeight,
                },
              ]}
            />
          </TouchableOpacity>
    ...
    if (isQuizListExist) {
      return quizItems.map((item, index) => (
        <TouchableOpacity
          ...
          style={[
            styles.quizItem,
            item.isCompleted && styles.quizItemCompleted,
          ]}
          ...
          <Image
            source={{
              uri:
                item.imageUrl ||
                'https://via.placeholder.com/80x80/FF8000/FFFFFF?text=Quiz',
              headers: {
            ...
            defaultSource={{
              uri: 'https://via.placeholder.com/80x80/FF8000/FFFFFF?text=Quiz',
            }}
          />
          <View style={styles.rightContent}>
            ...
            <Text
              style={[
                styles.itemRewardsText,
                item.isCompleted && styles.completedRewardsText,
              ]}>
